...
namespace Promed.Areas.Manage.Controllers
{
    public class FactsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Icon,Count,Text,OrderBy")] Fact fact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Icon,Count,Text,OrderBy")] Fact fact)
        {
            if (ModelState.IsValid)
            {
